...
w=4.50;       % Carga distribuida servicio, kN/m
Wm=6.15;      % Carga distribuida rotura, kN/m

% Parámetros del algoritmo de búsqueda
TP=100;          % Tamaño de la población
TT=4;           % Tamaño del torneo
GenMax=500;     % Número máximo de generaciones
